  ...
  return (
    <aside
      className={
        ...
        " bg-stone-300 top-0 space-y-28 text-gray- p-4 fixed w-full  h-screen md:static md:w-auto transition-all  overflow-hidden"
      }
    >
      ...
      <nav className="flex flex-col gap-3 w-full">
        ...
        <Link
          to={"/product_list"}
          className={
            pathname.includes("/product_list") ? activeLink : inactiveLink
          }
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
