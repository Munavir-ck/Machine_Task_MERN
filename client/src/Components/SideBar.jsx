    ...
    return (
        <aside
            className={
                ...
                " bg-stone-300 top-0 space-y-28 text-gray- p-4 fixed w-full  h-screen md:static md:w-auto transition-all"
            }
        >
            ...
            <nav className="flex flex-col gap-3 w-full">
                <div href={"/"} className={pathname === "/" ? activeLink : inactiveLink}>
                    <svg
                ...
                <div href={"/products"} className={pathname.includes("/products") ? activeLink : inactiveLink}>
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
                ...
                <div href={"/categories"} className={pathname.includes("/categories") ? activeLink : inactiveLink}>
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
                ...
                <div href={"/orders"} className={pathname.includes("/orders") ? activeLink : inactiveLink}>
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
